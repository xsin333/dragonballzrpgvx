...
class Game_Battler
  ...
  #===================以下追加分=========================
  attr_accessor :db_skills_get_flag        # スキルの取得状況
  attr_accessor :db_skills_get_sp          # スキルの取得スキルポイント
  #attr_accessor :skill_saiyanoti2         # サイヤ人の血2
  #attr_accessor :skill_saiyanoti3         # サイヤ人の血3
